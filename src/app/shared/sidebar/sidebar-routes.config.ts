...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/infopanel', title: 'ข้อมูลกิจกรรมบริการ', icon: 'ft-clipboard', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/activities', title: 'บันทึกกิจกรรมประจำวัน', icon: 'ft-codepen', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/servicelog', title: 'บันทึกกิจกรรมบริการ', icon: 'ft-command', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/deptnotified', title: 'แจ้งปัญหาใช้งานคอมฯ', icon: 'ft-zap', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    // { path: 'https://pixinvent.ticksy.com/', title: 'ออกจากระบบ', icon: 'ft-log-out', class: '', badge: '', badgeClass: '', isExternalLink: true, submenu: [] },
];
