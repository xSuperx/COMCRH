...
export class DeptnotifiedComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.GetDbNotifiedWaitYesterday();
    setInterval(() => {
      // console.log(
  ...
  GetDbNotifiedWaitYesterday(){
    ...
    this.http
      ...
      .subscribe(
        (data: any) => {
          this.DbListNotifiedYesterday = data;
          console.log( this.DbListNotifiedYesterday );
        }
      );
  }
